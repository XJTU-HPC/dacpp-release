...
shell dacpp::list haloShell(dacpp::Vector<double>& state READ_WRITE,
...
calc void haloStep(dacpp::Vector<double>& state, double* next) {
...
int main() {
    ...
    for (int i = 0; i < WIDTH; ++i) {
        state_data[i] = static_cast<double>((i % 5) + i);
    }
