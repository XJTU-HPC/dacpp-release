...
shell dacpp::list MATRIX_SINGLE_SPLIT(const dacpp::Matrix<int>& input,
...
calc void copyMatrixRows(dacpp::Matrix<int>& input,
                         dacpp::Matrix<int>& output) {
...
int main() {
    ...
    MATRIX_SINGLE_SPLIT(input, output) <-> copyMatrixRows;
